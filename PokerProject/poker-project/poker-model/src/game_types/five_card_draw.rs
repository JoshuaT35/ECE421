/// poker model for five card draw
...
pub struct FiveCardDrawDealer {
    base: PokerGameBase,
}

// unique functions
impl FiveCardDrawDealer {
    /// create a new FiveCardDrawDealer
    pub fn new() -> Self {
        Self {
...
// FiveCardDrawDealer defines functions declared in DealerGame, using PokerGameBase
impl DealerGame for FiveCardDrawDealer {
